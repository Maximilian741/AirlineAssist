...
window.RIGHTS_DATA = {
  ...
  rightsCards: [
    ...
    },
    {
      ...
      amounts: "No fee is capped or banned — this is a disclosure right, not money. The exact carry-on and 1st/2nd checked-bag fees plus your free allowance must appear on your e-ticket confirmation, and a bag-fee notice must appear on the first screen that quotes your fare.",
      triggers: "The first screen showing your fare carried no baggage-fee notice; OR your e-ticket confirmation left out your free bag allowance or the carry-on / 1st / 2nd checked-bag fees; OR the airline's homepage has no link to its optional-service fees; OR it raised bag fees without flagging it on the homepage.",
      howToClaim: "Screenshot the screen or confirmation that left the fees out, then file at transportation.gov/airconsumer/file-consumer-complaint citing 14 CFR 399.85 — failing to disclose is an unfair and deceptive practice under 49 U.S.C. 41712. Practically, before booking: look up the airline's own baggage, change, and cancellation fees, and check your fare class (Basic Economy usually adds restrictions).",
      legalBasis: "14 CFR 399.85 (the 2011 fee-disclosure rules). The 2024 ancillary-fee rule, 89 Fed. Reg. 34620, was vacated by the Fifth Circuit en banc in Airlines for America v. DOT, Feb 3, 2026, which reinstated the earlier rules; DOT re-codified them at 91 Fed. Reg. 40368, effective July 2, 2026.",
      sources: [
  ...
  // months from departure), the EU261 clock in trips.js / mobile trips.ts, and the EU note in
