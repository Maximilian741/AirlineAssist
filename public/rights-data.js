// rights-data.js — verified air-passenger-rights content.
//
// Every fact here was researched AND independently fact-checked against PRIMARY
// government sources: U.S. DOT, the eCFR / Cornell LII (regulation text), the
// Federal Register, Congress.gov, the EU (EUR-Lex), the UK CAA, and the Canadian
// Transportation Agency. Dollar amounts, deadlines, and legal citations were each
// confirmed against an official source and link out so anyone can check the receipts.
//
// Last verified: mid-2026. Laws and dollar figures change — the linked sources are
// the source of truth. If something here ever disagrees with the official page, the
// official page wins. Re-verify periodically.

window.RIGHTS_DATA = {
  // ---- What the airline legally OWES you (grouped by category in the UI) ----
  rightsCards: [
    {
      category: "refunds",
      headline: "Flight cancelled or seriously changed? You get your money back in CASH — not a voucher",
      plain: "If the airline cancels your flight, or changes it so much it counts as a 'significant change,' and you decide not to take the replacement flight or credit they offer, they must give you your money back automatically — real money, back to the card or account you paid with. Not a travel voucher. Not a credit. You can choose a voucher or a rebooking if YOU want to, but that's your call, never theirs. And you shouldn't have to fight for it.",
      amounts: "Full refund of the airfare plus any taxes and add-on fees you paid for things you didn't get. Refund rule in force since October 28, 2024.",
      triggers: "The airline cancels, OR makes a 'significant change' (see the next card for what counts), AND you choose not to accept the rebooking or credit they offer.",
      howToClaim: "Tell the airline (app, 'manage trip,' or phone): 'I am declining alternative transportation and requesting a refund to my original form of payment under 14 CFR Part 260.' Put it in writing and keep a copy. If they stall or push a voucher, file a complaint at transportation.gov/airconsumer.",
    ...
    },
    {
      ...
      plain: "The airline doesn't get to decide what 'big change' means anymore — the government does. Any ONE of these unlocks your refund right: your departure or arrival moves 3+ hours (domestic) or 6+ hours (international); they switch you to a different airport; they add a stop or connection you didn't have; or they downgrade you to a lower class (say, first class down to coach). Just one of these is enough.",
      amounts: "Departure or arrival shifted 3+ hours (domestic) / 6+ hours (international); OR a different airport; OR an added connection; OR a downgrade to a lower class of service. In force since October 28, 2024.",
      triggers: "Any single one of these changes — you don't need more than one.",
      howToClaim: "Compare your new itinerary to the one you bought. If it crosses any line above, tell the airline you're exercising your refund right under 14 CFR 260.2/260.6 to your original form of payment, and decline the rebooking if you don't want it.",
    ...
    },
    {
      ...
      plain: "Once a refund is owed, the clock is ticking. Paid by credit card? The money must be back within 7 business days. Paid by cash, check, or debit? Within 20 calendar days. If they blow past these deadlines, that's its own violation you can report.",
      amounts: "7 business days for credit/charge card; 20 calendar days for cash, check, debit, or other — counted from the earliest date you asked for the refund.",
    ...
    },
    {
      ...
      howToClaim: "Cancel through the same place you booked (airline site/app 'manage trip' or phone) within 24 hours and choose 'refund to original form of payment.' Clearest when you book directly with the airline; third-party sites may handle it differently.",
    ...
    },
    {
      ...
      plain: "If the airline sells more seats than the plane holds and bumps you against your will (you did NOT volunteer), federal law makes them pay you. How much depends on how late their replacement gets you there. They may wave a travel voucher at you — but you have the right to say no and take a check or cash instead.",
      amounts: "Lower tier: 200% of your one-way fare, capped at $1,075. Higher tier: 400% of your one-way fare, capped at $2,150. You get the LOWER of the percentage or the cap. These amounts took effect Jan 22, 2025 and are current for 2026.",
    ...
    },
    {
      ...
      plain: "For a flight within the U.S., it all comes down to how late the airline's substitute flight gets you to your destination. Under about an hour late, you may get nothing. Between one and two hours, you get the lower amount. Two or more hours late (or no decent substitute at all), you get the higher amount.",
    ...
    },
    {
      ...
      plain: "Don't assume you automatically pocket $1,075 or $2,150. You get the LOWER of (a) the percentage of your one-way fare and (b) the dollar cap. So if your fare was cheap, the percentage may land below the cap, and that smaller number is what you get. The caps are ceilings, not guarantees.",
    ...
    },
    {
      ...
      sources: [
        { label: "DOT — Airline Customer Service Dashboard", url: "https://www.transportation.gov/airconsumer/airline-customer-service-dashboard" }
      ]
    },
    {
      category: "baggage",
      headline: "Bag arrives late? Get your checked-bag fee back — 12 hours domestic, 15 or 30 hours international",
      plain: "If you paid to check a bag and it shows up late, the airline must refund that bag fee. Domestic: the bag counts as significantly delayed if it isn't delivered within 12 hours of your flight landing. International: 15 hours if your nonstop U.S.-to-foreign leg was 12 hours or less, or 30 hours if that leg was longer. One important catch: you only get the refund if you FILE A MISHANDLED BAGGAGE REPORT — so report the missing bag before you leave the airport.",
    ...
    },
    {
      ...
      sources: [
        { label: "ICAO — revised liability limits", url: "https://www.icao.int/news/international-air-travel-liability-limits-set-increase-enhancing-customer-compensation-0" }
      ]
    },
    {
      category: "fees",
      headline: "Paid for Wi-Fi or a seat you never got? You're owed that money back",
      plain: "The 2024 refund rule also covers extras you paid for but didn't receive — in-flight Wi-Fi that never worked, a seat selection you couldn't use, or other prepaid extras lost because your flight was cancelled, significantly changed, or you were bumped. If you don't get the service through no fault of your own, the airline must refund what you paid for it.",
      ...
      howToClaim: "Ask the airline in writing for a refund of the specific fee, noting it wasn't provided (keep screenshots/receipts — e.g., a Wi-Fi error). Cite 14 CFR Part 260. If denied, file at transportation.gov/airconsumer. Refunds go to your original payment.",
      legalBasis: "14 CFR Part 260; DOT Refund Final Rule (2024).",
      sources: [
        { label: "eCFR — 14 CFR Part 260", url: "https://www.ecfr.gov/current/title-14/chapter-II/subchapter-A/part-260" },
        { label: "DOT — automatic refunds final rule", url: "https://www.transportation.gov/briefing-room/biden-harris-administration-announces-final-rule-requiring-automatic-refunds-airline" }
    ...
    {
      category: "fees",
      headline: "Heads up: airlines are NOT required to show bag/change fees upfront — that rule was struck down",
      plain: "In 2024 DOT made a rule that would have forced airlines and booking sites to show you the fees for bags, changes, and cancellations while you shop. It never took full effect — the courts paused it, the industry sued, and on February 3, 2026 the full Fifth Circuit appeals court threw it out entirely. So as of mid-2026 there's NO federal rule forcing airlines to disclose these fees upfront. Be skeptical of any site claiming a 'new law' makes airlines bundle all fees into the headline price — that's not the law right now. You still have to look up bag and change fees yourself before you buy.",
      amounts: "No fees are mandated or capped. DOT's old rule is vacated.",
      triggers: "Nothing — the rule is no longer in force.",
      howToClaim: "Nothing to claim. Practically: before booking, look up the airline's own baggage, change, and cancellation fees, and check your fare class (Basic Economy usually adds restrictions). If an airline charges a fee it never disclosed, you can still complain at transportation.gov/airconsumer/file-consumer-complaint.",
      legalBasis: "Final rule 89 Fed. Reg. 34620 (Apr 30, 2024), vacated by the Fifth Circuit en banc in Airlines for America v. DOT, Feb 3, 2026.",
      sources: [
    ...
    },
    {
      ...
      plain: "Despite the headlines, there's no federal law forcing an airline to seat your young child next to you for free. DOT proposed such a rule, but it was never finalized and isn't in effect as of mid-2026. Some airlines promise it voluntarily; some don't. As of late 2025, airlines that guarantee free adjacent family seating include Alaska, American, Frontier, Hawaiian, and JetBlue; those that do NOT guarantee it include Delta, United, Southwest, and Allegiant. Commitments can change, so check before you book.",
  ...
  // ---- International cash compensation regimes (big and under-claimed) ----
  internationalCompensation: [
    {
      ...
      eligibility: "Your flight was cancelled (with less than 14 days' notice) or you arrived 3+ hours late, AND the cause was within the airline's control (mechanical, staffing, overbooking) — NOT 'extraordinary circumstances' like severe weather, ATC strikes, or security threats. €250 for flights up to 1,500 km; €400 for intra-EU over 1,500 km and other flights 1,500–3,500 km; €600 for flights over 3,500 km. The big surprise for Americans: ANY flight leaving Europe counts — so your Delta or United flight home from Paris or Rome qualifies. (A 2026 reform was only provisionally agreed and is NOT law yet; the current 3-hour / €250–€600 rules still apply.)",
      howToClaim: "1) Write to the airline first, citing 'EU Regulation 261/2004,' your flight number, date, and how late you arrived; demand cash, not a voucher. 2) If refused or ignored, escalate to the National Enforcement Body in the EU country where the disruption happened. 3) Or use a no-win-no-fee service (AirHelp, Flightright) that takes a cut. Keep boarding passes and delay notices. Claim deadline varies by country (often 2–3 years).",
      sources: [
        { label: "EUR-Lex — Regulation (EC) 261/2004", url: "https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32004R0261" }
      ]
    },
    {
      regime: "UK261",
      ...
      eligibility: "Same idea as EU261, in pounds. Cancellation or arrival 3+ hours late, caused by something within the airline's control (not severe weather or ATC strikes). £220 for flights under 1,500 km; £350 for 1,500–3,500 km; for flights over 3,500 km, £260 if you arrive 3–4 hours late and £520 if more than 4 hours late. Covers your U.S. carrier home from London. Per person.",
      howToClaim: "1) Complain to the airline citing 'UK261,' your flight details, and how late you arrived; ask for cash. 2) If refused or unresolved after 8 weeks, escalate to the airline's ADR provider, or to the UK CAA's Passenger Advice and Complaints Team (PACT). The CAA/ADR route is free. Court time limit is generally up to 6 years in England/Wales (5 in Scotland).",
      sources: [
        { label: "UK CAA — delays and cancellations", url: "https://www.caa.co.uk/air-passengers/travel-problems-and-rights/flight-delays-and-cancellations/delays/" }
      ]
    },
    {
      regime: "Canada APPR",
      ...
      eligibility: "A delay or cancellation within the airline's control (and not safety-required), where you arrive 3+ hours late and were notified 14 days or less before departure. Large airlines (Air Canada, WestJet): CAD 400 (3–6 hrs late), CAD 700 (6–9 hrs), CAD 1,000 (9+ hrs). Small airlines: CAD 125 / 250 / 500. Denied boarding (bumping): CAD 900 / 1,800 / 2,400. Does NOT apply to delays for safety reasons or causes outside the airline's control.",
      howToClaim: "File a WRITTEN claim with the airline within 1 YEAR of the disruption, stating the flight, the delay length, and that you're claiming APPR compensation. The airline has 30 days to pay or explain. If they refuse, complain to the Canadian Transportation Agency (CTA), which can investigate and order payment.",
      sources: [
        { label: "CTA — APPR highlights", url: "https://otc-cta.gc.ca/eng/air-passenger-protection-regulations-highlights" }
      ]
    }
  ],

  // ---- The ordered, numbered steps to actually get paid ----
  escalationLadder: [
    { step: 1, action: "Ask the airline directly — in writing", detail: "Start with the airline. Decline any voucher and clearly request a refund or the compensation you're owed 'to my original form of payment,' citing the rule (e.g., 14 CFR Part 260 for refunds, 14 CFR 250.5 for bumping). Use the app, 'manage trip,' or email so you have a paper trail. Keep your booking confirmation, cancellation/change emails, boarding pass, and receipts.", url: "" },
    ...
    { step: 3, action: "File a free DOT complaint", detail: "If the airline ignores or refuses you, file at the DOT Office of Aviation Consumer Protection. By federal rule the airline must acknowledge within 30 days and send a substantive written response within 60 days (30 days for disability complaints). DOT tracks complaints and uses them to open investigations and levy penalties, which often unsticks an individual case. You can file even after the airline already said no.", url: "https://www.transportation.gov/airconsumer/file-consumer-complaint" },
  ...
  // ---- The law: what's real, what's not, what's coming (honest status) ----
  legislation: [
    {
    ...
    },
    {
      ...
      year: "2024",
      status: "Signed into law and in force (effective Jan 22, 2025)",
      summary: "Roughly doubled involuntary-bumping compensation caps to $1,075 / $2,150 (from $775 / $1,550) and raised the domestic lost/damaged baggage liability cap to $4,700 (from $3,800). Both adjust for inflation every two years; the next review is expected around 2027.",
      whyItMatters: "These are the current, correct 2026 numbers. Airlines sometimes quote the old figures — now you can correct them.",
      sources: [
        { label: "Federal Register — 2024 revisions", url: "https://www.federalregister.gov/documents/2024/10/24/2024-23588/periodic-revisions-to-denied-boarding-compensation-and-domestic-baggage-liability-limits" }
      ]
    },
    {
      ...
      sources: [
        { label: "FTC — fees rule takes effect", url: "https://www.ftc.gov/news-events/news/press-releases/2025/05/ftc-rule-unfair-or-deceptive-fees-take-effect-may-12-2025" }
      ]
    },
    {
    ...
    },
    {
      ...
      sources: [
        { label: "Congress — S.3347", url: "https://www.congress.gov/bill/119th-congress/senate-bill/3347" }
      ]
    },
    {
      ...
      sources: [
        { label: "FAA — seat-size comments", url: "https://www.faa.gov/seat-size-comments" },
        { label: "Congress — H.R.3935 summary", url: "https://www.congress.gov/bill/118th-congress/house-bill/3935/summary/00" }
      ]
    }
  ],

  // ---- Who's actually fighting for travelers ----
  advocacyGroups: [
    { name: "DOT Office of Aviation Consumer Protection", url: "https://www.transportation.gov/airconsumer", what: "The federal watchdog for air travelers. Takes complaints, enforces the refund/bumping/tarmac rules, and runs the customer-service and family-seating dashboards. Your most powerful free lever." },
    { name: "Elliott Advocacy", url: "https://www.elliott.org/", what: "Nonprofit that helps travelers resolve disputes for free and publishes airline executive contact lists (elliott.org/company-contacts) for escalating stuck cases." },
    { name: "AirHelp", url: "https://www.airhelp.com/", what: "No-win-no-fee claims service that handles EU261 / UK261 / Canada APPR cash-compensation claims for you (takes a cut if it wins). Useful when an airline stonewalls a foreign-route claim." },
    { name: "Flightright", url: "https://www.flightright.com/", what: "Another no-win-no-fee service specializing in EU261 / UK261 air-passenger compensation claims, doing the paperwork and legal pursuit for a percentage of the payout." },
    { name: "Contact your members of Congress", url: "https://www.congress.gov/members/find-your-member", what: "To push pending bills (cash delay compensation, family seating, seat minimums), look up your members by ZIP and call the Capitol switchboard at 202-224-3121. Free and quick." }
  ],

  // ---- Check the airline's record (public data — links only) ----
  statsLinks: [
