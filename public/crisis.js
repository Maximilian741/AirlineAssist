// crisis.js — "It's happening RIGHT NOW" mode: what to do at the gate, in the moment.
//
// The claim tools work after the fact. This is for the 20 minutes at the airport when the
// decisions that determine your money actually get made — what to say, what to collect, and
// what NOT to accept. Every factual claim below is drawn from the same verified rules as
// rights-data.js (14 CFR 250/259/260, DOT dashboard commitments, EU261/UK261). No new law is
// asserted here — this is that content, recomposed for the moment of crisis.
  ...
  const SCENARIOS = [
    {
      ...
      now: [
        'Ask the gate agent, politely and specifically: “Is this delay within the airline’s control, or is it weather or air traffic control?” Write down the answer, the time, and the agent’s first name.',
        'At the 3-hour mark, ask for meal vouchers — every big U.S. airline has promised meals after a 3+ hour delay it caused. Those promises are published on the U.S. Department of Transportation’s customer-service dashboard, and they only apply if you ask.',
      ...
      say: '“I understand it’s not your fault. Since this is a controllable delay, I’d like the meal voucher this airline has publicly committed to — and if we go overnight, a hotel and transport.”',
      ...
      dontAccept: 'Don’t accept “there’s nothing we can do” before you’ve asked, by name, for the meal voucher — and a hotel and a ride if you’re stuck overnight — that this airline has promised for delays it caused.',
    },
    {
      id: 'cancel',
      emoji: '❌',
      ...
      say: '“Since the airline canceled my flight, if I choose not to travel I’m entitled to a refund to my original payment under the federal refund rule (14 CFR Part 260) — I’m not required to accept a travel credit. For now, please show me my rebooking options including partner airlines.”',
    ...
    },
    {
      ...
      money: 'Domestic: bag 12+ hours late = your bag FEE back; lost = up to $4,700 in provable contents. International: up to about $2,000 (set by treaty as 1,519 SDR) under the Montreal Convention.',
    ...
    },
    {
      ...
      now: [
        'The cause label decides your money: “weather or air traffic control” kills most compensation; “crew, maintenance, fueling” unlocks it. Airlines apply the label themselves — so verify.',
