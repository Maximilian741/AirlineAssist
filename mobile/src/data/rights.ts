...
export const RIGHTS_CARDS: RightCard[] = [
  ...
  },
  {
    ...
    amounts:
      'Departure or arrival shifted 3+ hours (domestic) / 6+ hours (international); OR a different airport; OR an added connection; OR a downgrade to a lower class of service. In force since October 28, 2024.',
